...
def main(args):
    ...
    val_loader = DataLoader(val_data,
        ...
        sampler=val_sampler, pin_memory=True, drop_last=True)
...
def validate(val_loader, device, model, config, text_features, test_crops, test_clips):
    ...
    with torch.no_grad():
        ...
        for i, (image, class_id) in enumerate(val_loader):
            ...
            video_embedding = model.module.encode_right_video(image_input)
            ...
            ########## gathering 
            i_features.append(concat_all_gather(video_embedding))
